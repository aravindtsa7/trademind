...
test('V2, V4, and V8 delegate wall-clock EOD from their runtime to StrategyHostLifecycle', () => {
...
test('StrategyHostLifecycle centralizes V2/V4/V8 scheduling through NseSessionEodCoordinator', () => {

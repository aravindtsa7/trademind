...
async function run(): Promise<void> {
  ...
  recovery.on('stateChanged',(state)=>{if(state==='DEGRADED')void host?.degrade('MARKET_DATA_DEGRADED');if(state==='READY')void host?.recovered('MARKET_DATA_READY');}); await host.start();
